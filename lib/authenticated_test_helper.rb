module AuthenticatedTestHelper
  # Sets the current base_user in the session from the base_user fixtures.
  def login_as(base_user)
    @request.session[:base_user] = base_user ? base_users(base_user).id : nil
  end
