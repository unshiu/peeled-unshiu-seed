...
# from racc grammer file "tmail-0.10.7/lib/tmail/parser.y.patched".
#
...
module_eval <<'..end tmail-0.10.7/lib/tmail/parser.y.patched modeval..idf94b7fb10a', 'tmail-0.10.7/lib/tmail/parser.y.patched', 333
...
..end tmail-0.10.7/lib/tmail/parser.y.patched modeval..idf94b7fb10a
...
module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 16
  def _reduce_1( val, _values)
 val[1]
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 17
  def _reduce_2( val, _values)
 val[1]
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 18
  def _reduce_3( val, _values)
 val[1]
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 19
  def _reduce_4( val, _values)
 val[1]
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 20
  def _reduce_5( val, _values)
 val[1]
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 21
  def _reduce_6( val, _values)
 val[1]
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 22
  def _reduce_7( val, _values)
 val[1]
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 23
  def _reduce_8( val, _values)
 val[1]
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 24
  def _reduce_9( val, _values)
 val[1]
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 25
  def _reduce_10( val, _values)
 val[1]
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 26
  def _reduce_11( val, _values)
 val[1]
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 27
  def _reduce_12( val, _values)
 val[1]
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 36
...
module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 45
...
module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 51
...
module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 56
  def _reduce_18( val, _values)
                  timezone_string_to_unixtime(val[0])
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 61
...
module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 67
...
module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 73
  def _reduce_23( val, _values)
                  val[1]
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 79
  def _reduce_24( val, _values)
                  join_domain(val[0])
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 83
  def _reduce_25( val, _values)
                  join_domain(val[2])
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 87
...
module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 93
  def _reduce_28( val, _values)
                  val[1]
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 98
  def _reduce_29( val, _values)
                  []
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 103
...
module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 109
  def _reduce_32( val, _values)
                  val[1]
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 113
...
module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 119
  def _reduce_35( val, _values)
                  val[1]
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 125
  def _reduce_36( val, _values)
                  val[0].spec
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 129
...
module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 136
...
module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 146
  def _reduce_47( val, _values)
 [ Address.new(nil, nil) ]
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 148
  def _reduce_48( val, _values)
 val
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 149
...
module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 158
  def _reduce_52( val, _values)
                  val
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 163
...
module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 171
...
module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 178
...
module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 181
  def _reduce_60( val, _values)
 val[0].join('.')
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 182
  def _reduce_61( val, _values)
 val[0] << ' ' << val[1].join('.')
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 189
...
module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 193
...
module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 196
  def _reduce_65( val, _values)
 [ val[1].join('.') ]
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 197
  def _reduce_66( val, _values)
 val[0].push val[3].join('.'); val[0]
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 199
  def _reduce_67( val, _values)
 Address.new( val[0], val[2] )
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 200
...
module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 203
  def _reduce_70( val, _values)
 (val[1] + 1).times { val[0].push '' }; val[0]
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 206
  def _reduce_71( val, _values)
 val
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 215
...
module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 217
  def _reduce_73( val, _values)
 val
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 226
...
module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 228
  def _reduce_76( val, _values)
 val[0] + val[1]
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 230
...
module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 248
...
module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 249
  def _reduce_87( val, _values)
 val
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 250
...
module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 253
  def _reduce_90( val, _values)
 val[0] << ' ' << val[1]
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 260
...
module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 264
  def _reduce_92( val, _values)
                  val
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 269
  def _reduce_93( val, _values)
                  [ val[0].to_i, val[2].to_i ]
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 274
  def _reduce_94( val, _values)
                  [ val[0].downcase, val[2].downcase, decode_params(val[3]) ]
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 278
  def _reduce_95( val, _values)
                  [ val[0].downcase, nil, decode_params(val[1]) ]
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 283
  def _reduce_96( val, _values)
                  {}
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 288
...
module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 296
  def _reduce_100( val, _values)
                  val[0].downcase
  end
.,.,

module_eval <<'.,.,', 'tmail-0.10.7/lib/tmail/parser.y.patched', 301
